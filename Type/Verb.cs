...
class Verb
{
	...
	public string Command
	{
		...
		set {
			if (HasKey("DropTarget")) ZapKey("DropTarget");
			SetValue("command", "DelegateExecute", null);
			SetValue("command", null, value);
		}
	}
